...
class TfsHolderFactory(
    ...
    override fun createViewHolder(view: View, viewType: Int): BaseViewHolder<*>? {
        return when (viewType) {
            R.layout.item_message_in -> MessageInViewHolder(view, currentUser, clickListener, longClickListener)
            R.layout.item_message_out -> MessageOutViewHolder(view, currentUser, clickListener, longClickListener)
