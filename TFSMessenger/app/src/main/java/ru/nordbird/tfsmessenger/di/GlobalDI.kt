...
class GlobalDI private constructor(context: Context) {
    ...
    private val subscriptionInteractor by lazy { ChannelsInteractorImpl(streamRepository, topicRepository) }
    private val streamInteractor by lazy { ChannelsInteractorImpl(streamRepository, topicRepository) }
